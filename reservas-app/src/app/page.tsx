// src/app/page.tsx
// ✅ OPTIMIZADO: Lazy loading de componentes no críticos
...
// ✅ LAZY LOADING: Componentes que NO son críticos para First Paint
...
const WhyPrivateShuttle = dynamic(
  () => import("@/components/sections/WhyPrivateShuttle"),
  {
    loading: () => <ComponentSkeleton />,
  },
);

const PrivateTours = dynamic(
  () => import("@/components/sections/PrivateTours"),
  {
    loading: () => <ComponentSkeleton />,
  },
);
...
export const metadata: Metadata = {
  ...
  description:
    "Book reliable private shuttle service in Costa Rica. Airport transfers from SJO and Liberia to La Fortuna, Manuel Antonio, Tamarindo, and more. Professional bilingual drivers, modern vehicles, fully licensed.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Professional private shuttle service with bilingual drivers. Book your Costa Rica airport transfer today.",
  ...
  twitter: {
    ...
    title: "Private Shuttle Costa Rica | Can't Wait Travel",
    description:
      "Professional airport transfers and private shuttle service across Costa Rica.",
    images: [
  ...
  return (
    <>
      ...
      <main id="main-content" className="min-h-screen overflow-x-hidden">
        ...
        <section className="relative h-screen overflow-x-hidden max-w-full">
          ...
          <div className="relative z-10 h-full flex flex-col items-center justify-center px-4 sm:px-6">
            <div className="text-center max-w-4xl">
              ...
              <p className="text-base sm:text-lg md:text-xl text-white/95 mb-6 drop-shadow-lg max-w-2xl mx-auto font-light px-4">
                Door-to-Door Transportation & Tailored Experiences Across Costa
                Rica
              </p>
        ...
        <section
          id="booking-form"
          className="relative -mt-32 z-20 px-4 sm:px-6 pb-20"
        >
          <Suspense
            fallback={

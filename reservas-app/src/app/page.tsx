        ...
        <section className="relative h-[70vh] min-h-[550px] max-h-[700px] overflow-hidden">
          ...
          <div className="absolute bottom-4 right-4 sm:bottom-6 sm:right-6 z-20 flex items-center gap-2">
            <a
              ...
              className="bg-green-500 hover:bg-green-600 p-2 rounded-full transition-all hover:scale-110 shadow-lg"
              aria-label="WhatsApp"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white/20 hover:bg-white/30 backdrop-blur-md p-2 rounded-full transition-all hover:scale-110"

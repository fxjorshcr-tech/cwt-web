        ...
        <section className="relative h-[70vh] min-h-[550px] max-h-[700px] overflow-hidden">
          ...
          <div className="relative z-10 h-full flex flex-col items-center justify-center px-4 sm:px-6">
            <div className="text-center max-w-5xl">
              ...
              {/* Social Media & WhatsApp Buttons */}
              <div className="flex items-center justify-center gap-3 sm:gap-4">
                <a
                  href="https://wa.me/50685962438"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-4 py-2.5 sm:px-5 sm:py-3 rounded-full font-semibold transition-all shadow-lg hover:shadow-xl hover:scale-105"
                  aria-label="WhatsApp"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white/20 hover:bg-white/30 backdrop-blur-md p-2.5 sm:p-3 rounded-full transition-all hover:scale-110"

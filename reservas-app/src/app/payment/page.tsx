...
// ✅ PAYMENT PAGE - Optimizado para móvil
'use client';

import { useEffect, useState, Suspense } from 'react';
import { useRouter, useSearchParams } from 'next/navigation';
import { ArrowLeft, Loader2, CreditCard, User, Mail, Phone, MapPin, Lock } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="lg:col-span-2 space-y-4 md:space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-3 md:gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        className={`min-h-[44px] md:min-h-[48px] ${errors.firstName ? 'border-red-500' : ''}`}
                      />
                      {errors.firstName && (
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        className={`min-h-[44px] md:min-h-[48px] ${errors.lastName ? 'border-red-500' : ''}`}
                      />
                      {errors.lastName && (
                ...
                <CardContent className="space-y-3 md:space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      className={`min-h-[44px] md:min-h-[48px] ${errors.email ? 'border-red-500' : ''}`}
                    />
                    {errors.email && (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className={`pl-10 min-h-[44px] md:min-h-[48px] ${errors.phone ? 'border-red-500' : ''}`}
                      />
                    </div>
                    {errors.phone && (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className={`pl-10 min-h-[44px] md:min-h-[48px] ${errors.country ? 'border-red-500' : ''}`}
                      />
                    </div>
                    {errors.country && (
              ...
              <Card className="border-blue-200 bg-blue-50">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="bg-white rounded-lg p-4 md:p-6 border-2 border-dashed border-blue-300">
                    <div className="text-center">
                      <Lock className="h-10 w-10 md:h-12 md:w-12 text-blue-600 mx-auto mb-2 md:mb-3" />
                  ...
                  <div className="flex items-center justify-center gap-3 md:gap-4 pt-2 md:pt-4">
                    ...
                    <div className="flex gap-2">
                      <CreditCard className="h-5 w-5 md:h-6 md:w-6 text-gray-400" />
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-[120px] md:top-[140px]">
                <Card>
                  <CardHeader className="pb-4">

        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm mb-4 leading-relaxed">
              Professional private shuttle service in Costa Rica. Licensed by ICT, fully insured, and trusted 
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              <li><Link href="/transfers?route=sjo-la-fortuna" className="hover:text-white transition">SJO → La Fortuna</Link></li>
              <li><Link href="/transfers?route=lir-tamarindo" className="hover:text-white transition">LIR → Tamarindo</Link></li>
              <li><Link href="/transfers?route=sjo-manuel-antonio" className="hover:text-white transition">SJO → Manuel Antonio</Link></li>
              <li><Link href="/transfers?route=sjo-monteverde" className="hover:text-white transition">SJO → Monteverde</Link></li>
              <li><Link href="/transfers?route=lir-papagayo" className="hover:text-white transition">LIR → Papagayo</Link></li>
            </ul>
          </div>
        </div>

          ...
          <table className="w-full bg-white">
            <thead>
              <tr className="border-b-2 border-gray-300">
                <th className="text-left p-2 sm:p-6 font-bold text-gray-700 text-xs sm:text-base w-1/4 sm:w-[160px] sticky left-0 bg-white z-10">Feature</th>
                <th className="p-2 sm:p-6 bg-gradient-to-br from-blue-50 to-blue-100 border-l border-r-2 border-blue-300 w-1/4 sm:min-w-[180px]">
                  <div className="font-bold text-blue-900 text-xs sm:text-lg">Private</div>
                  <div className="text-[10px] sm:text-sm text-blue-700 font-semibold hidden sm:block">(Can't Wait Travel)</div>
                </th>
                <th className="p-2 sm:p-6 text-center w-1/4 sm:min-w-[140px]">
            ...
            <tbody className="divide-y divide-gray-200">
              ...
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="p-2 sm:p-6 font-semibold text-gray-900 text-xs sm:text-base sticky left-0 bg-white">Privacy</td>
              ...
              {/* Direct Route */}
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="p-2 sm:p-6 font-semibold text-gray-900 text-xs sm:text-base sticky left-0 bg-white">Direct</td>
                <td className="p-2 sm:p-6 bg-blue-50/30 border-l border-r-2 border-blue-200 text-center">
                  <CheckCircle2 className="h-4 w-4 sm:h-7 sm:w-7 text-green-600 mx-auto" />
              ...
              {/* Travel Time */}
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="p-2 sm:p-6 font-semibold text-gray-900 text-xs sm:text-base sticky left-0 bg-white">Time</td>
                <td className="p-2 sm:p-6 bg-blue-50/30 border-l border-r-2 border-blue-200 text-center">
                  <CheckCircle2 className="h-4 w-4 sm:h-7 sm:w-7 text-green-600 mx-auto" />
              ...
              {/* Luggage Space */}
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="p-2 sm:p-6 font-semibold text-gray-900 text-xs sm:text-base sticky left-0 bg-white">Luggage</td>
                <td className="p-2 sm:p-6 bg-blue-50/30 border-l border-r-2 border-blue-200 text-center">
                  <CheckCircle2 className="h-4 w-4 sm:h-7 sm:w-7 text-green-600 mx-auto" />
              ...
              {/* No Driving Stress */}
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="p-2 sm:p-6 font-semibold text-gray-900 text-xs sm:text-base sticky left-0 bg-white">Relax</td>
                <td className="p-2 sm:p-6 bg-blue-50/30 border-l border-r-2 border-blue-200 text-center">
                  <CheckCircle2 className="h-4 w-4 sm:h-7 sm:w-7 text-green-600 mx-auto" />
              ...
              {/* Airport Pickup */}
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="p-2 sm:p-6 font-semibold text-gray-900 text-xs sm:text-base sticky left-0 bg-white">Pickup</td>
                <td className="p-2 sm:p-6 bg-blue-50/30 border-l border-r-2 border-blue-200 text-center">
                  <CheckCircle2 className="h-4 w-4 sm:h-7 sm:w-7 text-green-600 mx-auto" />
              ...
              {/* Flight Monitoring */}
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="p-2 sm:p-6 font-semibold text-gray-900 text-xs sm:text-base sticky left-0 bg-white">Flights</td>
                <td className="p-2 sm:p-6 bg-blue-50/30 border-l border-r-2 border-blue-200 text-center">
                  <CheckCircle2 className="h-4 w-4 sm:h-7 sm:w-7 text-green-600 mx-auto" />
              ...
              {/* Local Knowledge */}
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="p-2 sm:p-6 font-semibold text-gray-900 text-xs sm:text-base sticky left-0 bg-white">Local</td>
                <td className="p-2 sm:p-6 bg-blue-50/30 border-l border-r-2 border-blue-200 text-center">
                  <CheckCircle2 className="h-4 w-4 sm:h-7 sm:w-7 text-green-600 mx-auto" />

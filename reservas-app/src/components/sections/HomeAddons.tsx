...
export default function HomeAddons() {
  return (
    <section className="py-16 sm:py-20 bg-gradient-to-br from-orange-50 via-blue-50 to-green-50">
      <div className="container mx-auto px-4 sm:px-6 max-w-6xl">

        {/* Header */}
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm border border-orange-200 rounded-full mb-6">
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
          ...
          {/* Explorer Upgrade */}
          <div className="relative bg-gradient-to-br from-green-50 to-white rounded-2xl shadow-xl border-2 border-green-300 overflow-visible hover:shadow-2xl transition-all hover:-translate-y-1">
            {/* Deluxe Badge */}
            <div className="absolute -top-3 right-4 bg-gradient-to-r from-green-500 to-green-600 text-white text-xs font-bold px-4 py-1.5 rounded-full shadow-lg z-10">
              DELUXE
            </div>
